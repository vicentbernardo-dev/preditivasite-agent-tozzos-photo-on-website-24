...
// ../node_modules/sanity/lib/resources-D1VkLx7N.js
var releasesLocaleStrings = defineLocalesResources("releases", {
  ...
  * leading arrow already conveys "back", so the label names the destination only. */
  ...
  "publish-dialog.confirm-publish.update-drafts-description_one": "The existing draft of {{draftDocumentsLength}} document will be discarded so that drafts match the published release. Unpublished draft changes will be lost.",
  /** Description for the update existing drafts checkbox when multiple documents have existing drafts */
  "publish-dialog.confirm-publish.update-drafts-description_other": "The existing drafts of {{draftDocumentsLength}} documents will be discarded so that drafts match the published release. Unpublished draft changes will be lost.",
  ...
  "summary.no-documents-cardinality-one.description": "This scheduled draft does not contain a document. It may have been removed.",
  ...
  "summary.errors-found": "In order to publish or schedule the release, please resolve the issues found in the documents",
  ...
  "toast.publish.update-drafts-error": "The release was published, but existing drafts could not be updated: {{error}}",
...
//# sourceMappingURL=resources-D1VkLx7N-6RJABI4G.js.map
